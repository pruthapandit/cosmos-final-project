...
pattern (T-Arm / Raise Arms / Two-Arm Boxing / Pull) -- see TWO_ARM_GESTURES
and DIRECTIONAL_GESTURES below. predict_stream_ui.py itself is left
unmodified as a stable fallback.
"""
