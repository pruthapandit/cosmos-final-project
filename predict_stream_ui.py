...
# any of its recently_seen_gestures has been the (post-threshold)
...
def prediction_loop(
    ...
    while not stop_event.is_set():
        ...
        # If this tick's prediction is a "blocked" gesture, bounce it to
        # "None" while its source gesture is still within its lockout
        # window -- checked first, since a couple of these chain (a One-Arm
        # Boxing reading suppressed here as a Two-Arm-Boxing trailing
        # artifact shouldn't itself count as genuine evidence below).
